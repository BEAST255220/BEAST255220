...
async function updateEvents() {
    const Response = await fetch("https://drivershub.stridehaulage.com/api/tmp?endpoint=vtc/69772/events", {
        method: 'GET',
        headers: {
...
async function aupdateEvents() {
    const Response = await fetch("https://drivershub.stridehaulage.com/api/tmp?endpoint=vtc/69772/events/attending", {
        method: 'GET',
        headers: {
            accept: 'application/json',
            origin: ''
